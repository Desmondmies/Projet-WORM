...
def remplacement_bordure(m):
	...
	for i in range(n):
		m[i, 0] = CaseMatrice(inf_value, i, 0)
		m[0, i] = CaseMatrice(inf_value, 0, i)
		m[n - i -1, n - 1] = CaseMatrice(inf_value, n-i-1, n-1)
		m[n - 1 , n - i -1] = CaseMatrice(inf_value, n-1, n-i-1)
	return m
